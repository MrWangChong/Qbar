...
package com.wc.qbar.scan.camera;
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
    ...
    public void startSmoothZoom(int zoomValue) {
        if (camera != null) {
            ...
            //parameters.isSmoothZoomSupported()为false
...
//            }
    ...
    public void closeFlash() {
        if (camera != null) {
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                isOpenFlash = !setTorchMode(false);
//            } else {
            Camera.Parameters parameters = camera.getParameters();
...
//            }
    ...
    private boolean setTorchMode(boolean open) {
